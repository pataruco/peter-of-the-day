                ...
                <ul class="navigation__login row">
                    ...
                    @else
                        <li class="" id="js-toggle-slide-button">
                            <a href="#" class="navigation__username btn btn--black btn--no-border" role="button" aria-expanded="false">
                                {{ Auth::user()->name }}
                            </a>
                            <ul class="navigation__logged" role="" id="js-toggle-slide-container">
                                <li>
                                    <a href="{{ route('logout') }}" class="btn btn--no-border btn--black" onclick="event.preventDefault();
